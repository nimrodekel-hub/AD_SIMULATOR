...
לאיבוד — הכל יושב בגיטהב. אפשר לחבר פלטפורמה אחרת ולהמשיך.
...
Postgres), הכל נכתב לגיטהב דרך ה-API שלו — מנגנון אחסון אחד לכל המערכת, בלי
...
הפרדת המידע לענף `data` מנתקת את הקשר: המידע נשמר בגיטהב כמו שנדרש, והבנייה
...
**ההנחה הקריטית שנבדקת:** האם מנוע AI המוזנב בידע מבצעי מובנה יכול להבין בקשה
חופשית, להתאים אותה לידע הנכון, ולייצר ממנו תרחיש אמין. כל השאר משני לה.
