...
| `sensor` | **מה המכ"ם רואה** — טווח גילוי, אזור מת קרוב, זווית כיסוי (360° למכ"ם מסתובב, 120° למערך קבוע) וסרגל גובה. שונה מטווח הירי: הגילוי קובע כמה התרעה יש למפעיל, והזווית קובעת אם יש התרעה בכלל מכיוון מסוים. כל שדה יכול להיות ריק — מתכנן שיודע טווח ולא יודע תקרה ימלא מה שהוא יודע |
